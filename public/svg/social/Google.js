...
function Google(props) {
    return (
        ...
        >
            ...
            <path
                fill="url(#prefix__a)"
                d="M47.46 15.5l-1.37 1.48c-1.34 1.44-3.5 1.67-5.15.6-2.71-1.75-6.43-3.13-11-2.37-4.94.83-9.17 3.85-11.64 7.97l-8.03-6.08C14.99 9.82 23.2 5 32.5 5c5 0 9.94 1.56 14.27 4.46 2.04 1.37 2.36 4.25.69 6.04z"
            />
            <linearGradient
                id="prefix__b"
                x1={12.148}
            ...
            >
                ...
                <stop offset={0.612} stopColor="#ffcd49" />
                <stop offset={1} stopColor="#ffde44" />
            </linearGradient>
            <path
                fill="url(#prefix__b)"
                d="M16.01 30.91c-.09 2.47.37 4.83 1.27 6.96l-8.21 6.05c-1.35-2.51-2.3-5.28-2.75-8.22-1.06-6.88.54-13.38 3.95-18.6l8.03 6.08c-1.37 2.29-2.2 4.93-2.29 7.73z"
            />
            <linearGradient
                id="prefix__c"
                x1={29.76}
            ...
            <path
                fill="url(#prefix__c)"
                d="M50.45 51.28c-4.55 4.07-10.61 6.57-17.36 6.71-10.18.21-19.43-5.46-24.02-14.07l8.21-6.05C19.78 43.81 25.67 48 32.5 48c3.94 0 7.52-1.28 10.33-3.44l7.62 6.72z"
            />
            <linearGradient
                id="prefix__d"
                x1={46}
            ...
            <path
                fill="url(#prefix__d)"
                d="M59 31.97c.01 7.73-3.26 14.58-8.55 19.31l-7.62-6.72c2.1-1.61 3.77-3.71 4.84-6.15.29-.66-.2-1.41-.92-1.41H37c-2.21 0-4-1.79-4-4v-2c0-2.21 1.79-4 4-4h17c2.75 0 5 2.22 5 4.97z"
            />
        </svg>
    );
}
